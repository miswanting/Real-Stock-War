...
class Ui_BuyStock(object):
    def setupUi(self, BuyStock):
        ...
        self.spinBox_buy_amount.setSuffix("")
        self.spinBox_buy_amount.setMaximum(999999999)
        ...
        self.groupBox_account_info = QtWidgets.QGroupBox(BuyStock)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, BuyStock):
        ...
        self.groupBox_account_info.setTitle(_translate("BuyStock", "账户信息"))
